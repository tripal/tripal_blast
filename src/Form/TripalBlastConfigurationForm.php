...
class TripalBlastConfigurationForm extends ConfigFormBase {
  ...
  /**
   * Defines the name used to store settings for this module.
   */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['example_sequence'] = [
      '#type' => 'details',
      '#open' => FALSE,
      '#title' => $this->t('Set Example Sequences'),
      '#description' => $this->t('There is the ability to show example sequences built-in to the various
    ...
    $form['notification']['fld_text_blast_warning_text'] = [
      '#type' => 'textarea',
